  ...
  return (
    <div className="flex h-screen bg-slate-950">
      ...
      <div className="flex-1 overflow-auto">
        {/* Header */}
        <div className="bg-slate-900/50 backdrop-blur-sm border-b border-slate-800 px-6 py-4 sticky top-0 z-10">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4" data-testid="kpi-cards">
            {kpiCards.map((card, index) => {
              ...
              return (
                <div 
                  key={card.label} 
                  className="bg-slate-900/80 backdrop-blur-sm rounded-xl border border-slate-800 p-4 hover:border-slate-700 transition-all"
                ...
                >
                  ...
                  <p className={`text-2xl font-bold text-white ${card.isLarge ? 'text-xl' : ''}`}>
