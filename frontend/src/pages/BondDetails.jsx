          ...
          <div className="lg:col-span-3 metric-card rounded-md">
            <div className="flex items-center justify-between mb-4">
              ...
              <span className="text-sm text-gray-500">
                {(displayInterestPayments.length + displayPrincipalPayments.length)} payments
              </span>
            </div>
            ...
            <div className="border rounded-lg overflow-hidden">
              <div className="max-h-96 overflow-y-auto">
                <table className="w-full text-sm">
                  ...
                  <tbody>
                    {(() => {
                      // Combine and sort all cashflows by date
                        ...
                        return (
                          <tr key={idx} className={`border-b last:border-0 ${isPast ? 'bg-gray-50 text-gray-400' : 'hover:bg-gray-50'}`}>
                            ...
                            <td className="p-3 text-right font-mono">
                              {interest > 0 ? (
                                <span className="text-blue-600">₹{interest.toLocaleString('en-IN')}</span>
                              ) : (
                            ...
                            <td className="p-3 text-right font-mono">
                              {principal > 0 ? (
                                <span className="text-green-600">₹{principal.toLocaleString('en-IN')}</span>
                              ) : (
                                <span className="text-gray-300">-</span>
                              )}
                            </td>
